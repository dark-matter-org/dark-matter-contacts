...
// Called from: org.dmd.mvw.tools.mvwgenerator.util.GxtEnumMappingFormatter.formatEnumMapping(GxtEnumMappingFormatter.java:28)
import java.util.ArrayList;                                                 // Our mapping type - (GxtEnumMappingFormatter.java:21)
import java.util.List;                                                      // Required by combo box - (GxtEnumMappingFormatter.java:22)
import org.dmd.mvw.client.gxtforms.implementation.GxtEnumMappingIF;         // Our interface - (GxtEnumMappingFormatter.java:24)
import org.dmd.mvw.client.gxtforms.implementation.GxtEnumValue;             // Our base enum representation - (GxtEnumMappingFormatter.java:23)

// org.dmd.mvw.tools.mvwgenerator.util.GxtEnumMappingFormatter.formatEnumMapping(GxtEnumMappingFormatter.java:30)
