...
public class ContactListViewOriginal extends ContactListViewBaseImpl {
	...
	public ContactListViewOriginal(ContactListViewPresenterIF presenter, MvwRunContextIF rc) {
		super(presenter, rc);
