...
public class DmcTypeContactTypeEnumSET extends DmcTypeContactTypeEnum implements Serializable {
     ...
     private final static Iterator<ContactTypeEnum> emptyList =  (new HashSet<ContactTypeEnum>()).iterator();
    ...
    public DmcTypeContactTypeEnumSET getNew(){
        return(new DmcTypeContactTypeEnumSET(getAttributeInfo()));
    }
    ...
    public Set<ContactTypeEnum> getMVCopy(){
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    return(new HashSet<ContactTypeEnum>());
                else
