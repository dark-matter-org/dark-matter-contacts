...
import org.dmd.examples.contacts.client.application.extended.ContactAppController;                                        // Used by ContactAppControllerRCI - (RunContextItem.java:428)
import org.dmd.examples.contacts.client.application.generated.mvw.ContactsappRunContextIF;                                // Contactsapp run context - (RunContextItem.java:405)
import org.dmd.examples.contacts.client.application.generated.mvw.places.ContactWebApplicationPlaceHistoryMapper;         // Used by historyMapper - (RunContextItem.java:428)
import org.dmd.examples.contacts.client.mvwmodule.contacts.extended.listing.ContactListView;                              // Used by ContactListViewRCI - (RunContextItem.java:416)
...
import org.dmd.examples.contacts.client.mvwmodule.contacts.generated.mvw.presenters.ContactListPresenterAsyncIF;          // Asynchronous creation of ContactListPresenter - (RunContextItem.java:422)
import org.dmd.examples.contacts.client.mvwmodule.contacts.generated.mvw.views.ContactListViewIF;                         // The ContactListView - (RunContextItem.java:415)
import org.dmd.examples.contacts.client.mvwmodule.contacts.generated.mvw.views.EditContactViewAsyncIF;                    // Asynchronous creation of  EditContactView - (RunContextItem.java:412)
import org.dmd.examples.contacts.client.mvwmodule.contacts.generated.mvw.views.EditContactViewIF;                         // The EditContactView - (RunContextItem.java:411)
import org.dmd.examples.contacts.client.mvwmodule.contacts.resources.Images;                                              // Used by images - (RunContextItem.java:428)
import org.dmd.examples.contacts.client.mvwmodule.login.extended.LoginView;                                               // Used by LoginViewRCI - (RunContextItem.java:416)
import org.dmd.examples.contacts.client.mvwmodule.login.generated.mvw.LoginRunContextIF;                                  // Login run context - (RunContextItem.java:405)
import org.dmd.examples.contacts.client.mvwmodule.login.generated.mvw.views.LoginViewIF;                                  // The LoginView - (RunContextItem.java:415)
