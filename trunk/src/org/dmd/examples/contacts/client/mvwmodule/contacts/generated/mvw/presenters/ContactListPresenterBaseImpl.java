package org.dmd.examples.contacts.client.mvwmodule.contacts.generated.mvw.presenters;
...
import org.dmd.examples.contacts.client.mvwmodule.contacts.generated.mvw.events.AddContactCompleteEvent;                             // Required by AddContactCompleteEvent - (Event.java:205)
import org.dmd.examples.contacts.client.mvwmodule.contacts.generated.mvw.events.AddContactCompleteEventHandler;                      // Required by AddContactCompleteEvent - (Event.java:206)
import org.dmd.examples.contacts.client.mvwmodule.contacts.generated.mvw.events.EditContactCompleteEvent;                            // Required by EditContactCompleteEvent - (Event.java:205)
import org.dmd.examples.contacts.client.mvwmodule.contacts.generated.mvw.events.EditContactCompleteEventHandler;                     // Required by EditContactCompleteEvent - (Event.java:206)
import org.dmd.examples.contacts.client.mvwmodule.contacts.generated.mvw.views.ContactListViewIF;                                    // View interface - (View.java:155)
import org.dmd.examples.contacts.client.mvwmodule.contacts.generated.mvw.views.ContactListViewIF.ContactListViewPresenterIF;         // Presenter interface - (View.java:152)
