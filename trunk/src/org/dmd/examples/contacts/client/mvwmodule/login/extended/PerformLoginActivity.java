package org.dmd.examples.contacts.client.mvwmodule.login.extended;
...
import org.dmd.examples.contacts.client.mvwmodule.login.generated.mvw.activities.PerformLoginActivityBaseImpl;
...
public class PerformLoginActivity extends PerformLoginActivityBaseImpl {
	...
	protected void handleLoginResponse(LoginResponseDMO response) {
		...
		// Nothing to do here - whatever component triggered the login activity
		// will listen for the LoginCompleteEvent and proceed from there.
