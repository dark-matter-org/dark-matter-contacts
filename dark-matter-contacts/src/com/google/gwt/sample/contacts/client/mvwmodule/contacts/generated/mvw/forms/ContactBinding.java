...
import com.google.gwt.sample.contacts.shared.generated.dmo.ContactDMO;            // For the object we're editting
import com.google.gwt.sample.contacts.shared.generated.dmo.ContactsDMSAG;         // Required schema
import org.dmd.dmc.DmcNamedObjectIF;                                              // Used when testing if an object named
import org.dmd.dmc.DmcValueException;                                             // Required if we have modification errors
import org.dmd.dmc.DmcValueExceptionSet;                                          // Required if we have modification errors
import org.dmd.dmc.presentation.DmcPresentationTrackerIF;                         // Presentation tracker
import org.dmd.dms.generated.dmo.MetaDMSAG;                                       // Required when edit object has no name
import org.dmd.dms.generated.types.DmcTypeModifierMV;                             // Required when edit object has no name
import org.dmd.dms.generated.types.adapters.StringSVAdapter;                      // Adapter for firstName
import org.dmd.mvw.client.gxtforms.editors.GxtTextField;                          // Editor
